...
import { updateProductAvailabilitySchema } from '@/schemas/product.schema';
import { authenticate } from '@/middleware/auth.middleware';

/**
 * PUT /api/vendors/:vendorId/products/:productId/availability - Update product availability
 */
export async function PUT(
  ...
  try {
        ...
        return NextResponse.json(
          {
            error: {
              code: 'FORBIDDEN',
              message: 'You can only update availability for your own products',
            },
          },
          { status: 403 }
        );
    ...
    const validatedData = updateProductAvailabilitySchema.parse(body);
