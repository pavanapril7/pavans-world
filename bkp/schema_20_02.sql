...
CREATE TABLE public."DeliveryPartner" (
    ...
    "currentLocation" public.geography(Point,4326)
);
...
--
-- Name: idx_address_location; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_address_location ON public."Address" USING gist (location);


--
-- Name: idx_delivery_partner_location; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_delivery_partner_location ON public."DeliveryPartner" USING gist ("currentLocation");


--
-- Name: idx_location_history_location; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_location_history_location ON public."LocationHistory" USING gist (location);
...
--
-- Name: idx_vendor_location; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_vendor_location ON public."Vendor" USING gist (location);
